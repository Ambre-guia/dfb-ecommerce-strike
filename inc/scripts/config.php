...
function my_load_scripts()
{
	...
	wp_enqueue_script('three-js', 'https://cdnjs.cloudflare.com/ajax/libs/three.js/r83/three.js', array(), null, true);
	...
	wp_enqueue_script('tween-max', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.4/TweenMax.min.js', array(), null, true);
	wp_enqueue_script('webgl-slider', get_template_directory_uri() . '/assets/js/webgl-slider.js', array('three-js', 'imagesloaded', 'tween-max'), '1.0', true);
