            ...
            <div id="slider-content" class="slider-content">
                ...
                if ($tarifs->have_posts()) :
                    ...
                    while ($tarifs->have_posts()) : $tarifs->the_post();
                        ...
                        echo '<a href="' . get_the_permalink() . '" data-slide-link="' . $index . '" class="btn readmorelink nopadding white' . $active_class . '" style="display: ' . ($index === 0 ? 'block' : 'none') . '">En savoir plus sur ' . get_the_title() . '</a>';
                        $index++;
                    endwhile;
