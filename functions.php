...
function dfb_register_project_cpt()
{
    ...
    $labels2 = array(
        'name'               => _x('Produits', 'post type general name', 'dfb-ecommerce-strike'),
        'singular_name'      => _x('Produit', 'post type singular name', 'dfb-ecommerce-strike'),
        'menu_name'          => _x('Produits', 'admin menu', 'dfb-ecommerce-strike'),
        'name_admin_bar'     => _x('Produit', 'add new on admin bar', 'dfb-ecommerce-strike'),
        'add_new'            => _x('Ajouter', 'produit', 'dfb-ecommerce-strike'),
        'add_new_item'       => __('Ajouter un nouveau produit', 'dfb-ecommerce-strike'),
        'new_item'           => __('Nouveau produit', 'dfb-ecommerce-strike'),
        'edit_item'          => __('Modifier le produit', 'dfb-ecommerce-strike'),
        'view_item'          => __('Voir le produit', 'dfb-ecommerce-strike'),
        'all_items'          => __('Tous les produits', 'dfb-ecommerce-strike'),
        'search_items'       => __('Rechercher des produits', 'dfb-ecommerce-strike'),
        'parent_item_colon'  => __('Produits parents:', 'dfb-ecommerce-strike'),
        'not_found'          => __('Aucun produit trouvé.', 'dfb-ecommerce-strike'),
        'not_found_in_trash' => __('Aucun produit trouvé dans la corbeille.', 'dfb-ecommerce-strike')
    );
    ...
    $args2 = array(
        'labels'             => $labels2,
        'description'        => __('Catalogue des produits.', 'dfb-ecommerce-strike'),
        'public'             => true,
        'publicly_queryable' => true,
        'show_ui'            => true,
        'show_in_menu'       => true,
    ...
    register_post_type('produit', $args2);
    ...
    $taxonomy_labels2 = array(
        'name'              => _x('Catégories de produits', 'taxonomy general name', 'dfb-ecommerce-strike'),
        'singular_name'     => _x('Catégorie de produit', 'taxonomy singular name', 'dfb-ecommerce-strike'),
        'search_items'      => __('Rechercher des catégories', 'dfb-ecommerce-strike'),
        'all_items'         => __('Toutes les catégories', 'dfb-ecommerce-strike'),
        'parent_item'       => __('Catégorie parente', 'dfb-ecommerce-strike'),
        'parent_item_colon' => __('Catégorie parente:', 'dfb-ecommerce-strike'),
    ...
    register_taxonomy('categorie-produit', array('produit'), $taxonomy_args2);
}
